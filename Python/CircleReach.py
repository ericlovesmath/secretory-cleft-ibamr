...
# Variables
r1, (x1, y1) = 1, (2.5, 3)                       # Circle 1, Radius and Center
...
# File output
file_out.write(f"{n_big + n} # INACCURATE number of vertices in file\n")
...
for x in range(1,5*n_sm//16):
    file_out.write(f"{n//16 + x} {n_big + n//2 - n//4 - x} {b10(spring_const)} {b10(0.2)}\n")
for x in range(1,5*n_sm//16):
    file_out.write(f"{(-n//16 - x)%n_big} {n_big + n//2 + n//4 + x} {b10(spring_const)} {b10(0.2)}\n")
